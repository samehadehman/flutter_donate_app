...
import 'package:hello/pages/volunteer_page.dart';
...
class SimpleSearchDelegate extends SearchDelegate<String> {
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestions = searchItems.where((item) => item.contains(query)).toList();
...
class HomePage extends StatelessWidget {
  ...
  child: Row(
    mainAxisAlignment: MainAxisAlignment.center,
    children: [
      sectionCard(context, 'الحملات', Icons.campaign, DummyPage('الحملات')),
      sectionCard(context, 'التبرع العيني', Icons.volunteer_activism, DummyPage('التبرع العيني')),
      sectionCard(context, 'الكوارث', Icons.warning, DummyPage('الكوارث')),
      sectionCard(context, 'قسم التطوع', Icons.groups, VolunteerCampaignsPage()), // ✅ هنا صفحة التطوع الحقيقية
    ],
  ),
),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return buildEmergencyCard(
                      ...
                      imagePath: 'lib/images/slider1.jpg',
                      location: 'ريف دمشق',
                      money: 3500,
                      days: '${index + 5}',
                    );
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Expanded(child: buildStatBox('عدد التبرعات العينية', '180')),
                    ],
                  ),
                ],
              ),
 ...
 class DummyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('صفحة $title', style: TextStyle(fontSize: 30)),
      ),
    );
  }
}
...
Widget sectionCard(BuildContext context, String title, IconData iconData, Widget targetPage)
 {
    return Container(
  ...
  Navigator.push(
    ...
    MaterialPageRoute(builder: (_) => targetPage),
              ...
              child: Container(
                ...
                height: 80,
                child: Center(
                  child: Icon(iconData, color: dark_Green, size: 30),
                ),
              ),
            ),
          ),
